        ...
        <div className="mt-8 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {myModels.map((model) => (
            <div key={model.id} className="glass-panel flex flex-col rounded-2xl p-5 border border-border-subtle hover:scale-[1.01] transition-all">
              <div className="relative aspect-video w-full overflow-hidden rounded-lg bg-background-alt">
                {model.thumbnailUrl ? (
                  <img
                  ...
                  <div className="flex h-full w-full items-center justify-center bg-background-alt text-text-tertiary">
